...
**Input**: `specs/refactor-002-rename-package-x/refactor-spec.md`, `specs/refactor-002-rename-package-x/plan.md`, `specs/refactor-002-rename-package-x/behavioral-snapshot.md`
...
- [ ] T003 Capture baseline metrics (before)
  ```bash
  .specify/extensions/workflows/refactor/measure-metrics.sh --before --dir "specs/refactor-002-rename-package-x"
  ```
  **File**: `specs/refactor-002-rename-package-x/metrics-before.md`
...
- [ ] T007 Confirm behavioral snapshot “before” sections are accurate
  ...
  **File**: `specs/refactor-002-rename-package-x/behavioral-snapshot.md`
...
- [ ] T047 Capture metrics (after)
  ```bash
  .specify/extensions/workflows/refactor/measure-metrics.sh --after --dir "specs/refactor-002-rename-package-x"
  ```
  **Files**: `specs/refactor-002-rename-package-x/metrics-after.md`, `specs/refactor-002-rename-package-x/metrics-before.md`
...
- [ ] T049 Update refactor spec status checkboxes
  ...
  **File**: `specs/refactor-002-rename-package-x/refactor-spec.md`
